...
`,Dd=e=>d.jsx(jd,{className:Qr({up:Math.sign(e)===-1}),children:d.jsx("use",{xlinkHref:"svg/sprite.svg#angle"})});function Nd(){const{ref:e,height:t=1}=Wt(),r=Fe(),{currenciesList:n,exchangeCurrency:o}=V(h=>h.config),{data:s,isLoading:i,error:a}=V(h=>h.cryptoData),l=T.useMemo(()=>n.map(({id:h})=>h).join(","),[n]),u=!i&&!a,c=!i&&a,f=i&&!a,m=T.useCallback(()=>r(jt({fromCurrencies:l,toCurrency:o.id})),[l,o.id]),y=async()=>{await it(1e3),r(Rd(Td))};return T.useEffect(()=>{y();const h=setInterval(()=>{y()},lt);return()=>{clearInterval(h)}},[m]),d.jsxs(Od,{ref:e,children:[d.jsx(kr,{children:"Name"}),d.jsxs(kr,{children:["Average price(",o.symbol,")"]}),d.jsx(kr,{children:"24h Change(%)"}),u&&s.map(({id:h,name:x,symbol:v,current_price:C,price_change_percentage_24h:S})=>d.jsxs(T.Fragment,{children:[d.jsxs(Ad,{children:[v," ",d.jsx("span",{children:x})]}),d.jsx($d,{children:C}),d.jsxs(Pd,{children:[Math.abs(S),d.jsx("span",{children:Dd(S)})]})]},h)),f&&d.jsx(xo,{children:d.jsx(Te,{height:`${t/1.5}px`})}),c&&d.jsx(xo,{children:d.jsx(Ue,{})})]})}const Ve={minHeight:240,group:"shared",cached:!1},Ke={minWidth:315,cached:!0},ee=(e=!0)=>({news:{...Ve,...e&&Ke,id:"news",title:"News",content:d.jsx(ru,{})},history:{...Ve,...e&&Ke,id:"history",title:"Trade history",content:d.jsx(uu,{})},cryptocurrencies:{...Ve,...e&&Ke,id:"cryptocurrencies",title:"Cryptocurrencies",content:d.jsx(Ll,{})},overview:{...Ve,...e&&Ke,id:"overview",title:"Market overview",content:d.jsx(Gl,{})},trends:{...Ve,...e&&Ke,id:"trends",title:"Trends 24h",content:d.jsx(Nd,{})}}),bo={dockbox:{mode:"vertical",children:[{mode:"horizontal",size:260,children:[{tabs:[ee().news]},{tabs:[ee().history]}]},{size:180,tabs:[ee().cryptocurrencies]},{size:260,mode:"horizontal",children:[{tabs:[ee().overview]},{mode:"horizontal",tabs:[ee().trends]}]}]}},wo={dockbox:{mode:"vertical",children:[{tabs:[ee(!1).trends,ee(!1).news,ee(!1).history,ee(!1).overview,ee(!1).cryptocurrencies]}]}},_o={currenciesList:Ir.slice(0,6),exchangeCurrency:Nr.USD,theme:It.DARK,serializedDockbox:null,persistentDockbox:!1},Rn=Sn({name:"config",initialState:_o,reducers:{setCurrenciesList:(e,t)=>{e.currenciesList=t.payload},setExchangeCurrency:(e,t)=>{e.exchangeCurrency=t.payload},setTheme:(e,t)=>{e.theme=t.payload},setSerializedDockbox:(e,t)=>{e.serializedDockbox=t.payload},setPersistentDocbox:(e,t)=>{e.persistentDockbox=t.payload},resetConfig:()=>_o}}),{setCurrenciesList:Xs,setExchangeCurrency:Qs,setTheme:ei,setSerializedDockbox:ot,setPersistentDocbox:ti,resetConfig:Id}=Rn.actions;Rn.reducer;function ri(){return Di()<=1200}function Bd(){const e=ri(),t=e?wo:bo,r=Fe(),n=V(f=>f.config.serializedDockbox),o=JSON.parse(String(n)),[s,i]=T.useState(o||t),a=ee(!e),l=T.useMemo(()=>({shared:{floatable:!1,maximizable:!e,disableDock:e}}),[e]),u=T.useCallback(({id:f})=>a[f],[a]),c=T.useCallback(f=>{i(f),r(ot(JSON.stringify(f)))},[]);return T.useEffect(()=>{if(e)i(wo);else{const f=o||bo;i(f),r(ot(JSON.stringify(f)))}},[e]),T.useEffect(()=>{n||i(t)},[n]),{dockbox:s,groups:l,loadTab:u,onDockboxChange:c}}const Ld=w.section`
  height: 100%;
  width: 100%;
...
`,Gd=w.img`
  ...
  max-height: 260px;
  z-index: -1;
`;function Wd(){const e=st(),t=()=>{e("/")};return d.jsx(zd,{children:d.jsxs(Ud,{children:[d.jsx(Hd,{children:"404"}),d.jsx("p",{children:"Page not found!"}),d.jsx(Gd,{src:"images/404.webp",alt:"Broken bitcoin",width:"280",height:"260"}),d.jsxs(Ps,{type:"button",onClick:t,children:[d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#home"})}),d.jsx("span",{children:"Home"})]})]})})}const qd={user:null},Tn=Sn({name:"auth",initialState:qd,reducers:{login:(e,t)=>{e.user=t.payload},logout:e=>{e.user=null}}}),{login:Ot,logout:Vd}=Tn.actions;Tn.reducer;function Jr(e){return d.jsx(ut,{...e})}const Kd=w.header`
  ${ye};
  width: 100%;
  max-height: 100px;
  padding: 30px;
...
`;function of(){const e=st(),{user:t}=V(s=>s.auth),r=Fe(),n=Xr(Ao),o=async()=>{if(confirm("Logout confirmation"))try{await wi(n),r(Vd()),r(Id()),e("/")}catch{console.log("signOut fail")}};return d.jsxs(ef,{children:[d.jsx(tf,{children:d.jsx(di,{to:"/","aria-label":"Return to home page",children:d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#logo"})})})}),d.jsx(Qd,{}),d.jsxs(rf,{children:[d.jsx(nf,{onClick:()=>r(ot(null)),"aria-label":"Reset layout",children:d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#reset"})})}),t&&d.jsx(ni,{onClick:o,"aria-label":"Log out",children:d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#log-out"})})})]})]})}const sf=w.div`
  display: flex;
`,af=w.div`
  ${dt};
  width: 100%;
