...
`;function Il({image:e,symbol:t,current_price:r,position:n}){const{ref:o,width:s=1}=Wt(),{id:i}=V(g=>g.config.exchangeCurrency),a=Za(r),[l,u]=T.useState([]),[c,f]=T.useState(!0),[m,y]=T.useState(!1),S=n==="even"?"#4DFFDF":"#E323FF",C=!m&&!c,v=T.useMemo(()=>Qr({positive:r<Number(a),negative:r>Number(a)}),[r,a]),b=async()=>{f(!0),await st(1e3),u(Wa(vl)),f(!1)};return T.useEffect(()=>{b();const g=setInterval(()=>{b()},ct);return()=>{clearInterval(g)}},[t]),d.jsxs(Ol,{ref:o,children:[d.jsx(Al,{children:d.jsx("img",{src:e,alt:t,width:"50",height:"50"})}),d.jsxs($l,{children:[d.jsxs("span",{children:[t,d.jsx(Pl,{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#arrow-right"})}),i]}),a&&d.jsx(d.Fragment,{children:d.jsx(Nl,{className:v,children:d.jsx("use",{xlinkHref:"svg/sprite.svg#circled-arrow"})})})]}),d.jsx(Dl,{className:v,children:Va(t,r)}),d.jsxs("div",{children:[C&&d.jsx(ji,{width:s,height:200,domainPadding:{y:[50,0]},color:S,children:d.jsx(Po,{data:l})}),c&&d.jsx(Te,{height:"150px"}),m&&d.jsx(Ue,{})]})]})}const Bl=w.div`
  ${pn};
  height: calc(100% - 1px);
  overflow-y: hidden;
  overflow-x: auto;
...
`;function Qd(){const{user:e}=V(t=>t.auth);return d.jsxs(Xd,{children:[d.jsx(So,{to:"/","aria-label":"Home page",children:d.jsx("span",{children:d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#home"})})})}),e&&d.jsx(So,{to:"/settings","aria-label":"Settings",children:d.jsx("span",{children:d.jsx("svg",{children:d.jsx("use",{xlinkHref:"svg/sprite.svg#settings"})})})})]})}const ef=w.div`
  ${ut};
  position: sticky;
  top: 0;
  left: 0;
...
`,cf=w.main`
  ${hn};
  height: 100%;
`;function lf(){const e=Xr(),t=Fe(),[r,n]=T.useState(!0);return T.useEffect(()=>{n(!0),_i(e,async o=>{if(o&&o.email){t(jt({email:o.email,uid:o.uid,photoURL:o.photoURL||null,displayName:o.displayName}));const s=await Si(o);if(s){const{currenciesList:i,exchangeCurrency:a,theme:l,serializedDockbox:u}=s;i&&t(Xs(i)),a&&t(Qs(a)),l&&t(ei(l)),u&&(t(Ht(u)),t(ti(!0)))}}n(!1)})},[]),d.jsxs(d.Fragment,{children:[r&&d.jsx(Te,{}),!r&&d.jsxs(sf,{children:[d.jsx(of,{}),d.jsxs(af,{children:[d.jsx(Jd,{}),d.jsx(cf,{children:d.jsx(fi,{})})]})]})]})}const uf=/^(([^<>()\[\]\\.,;:\s@"]+(.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@(([[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}])|(([a-zA-Z-0-9]+.)+[a-zA-Z]{2,}))$/,df=/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.* ).{6,}$/,ff=e=>Ii().shape({email:pr().email("Invalid email format.").matches(uf,"Email address is required.").required(),password:pr().matches(df,"Password must contain one digit from 0 to 6, one lowercase letter, one uppercase letter, one special character, no spaces and at least 6 characters long.").required("Pasword is required."),...!e&&{repeatPassword:pr().oneOf([Bi("password")],"Passwords don't match.").required("Repeat password is required.")}}),pf=w.main`
  ${tt};
  position: relative;
  height: 100vh;
  padding: 10px;
