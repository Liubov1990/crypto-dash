...
const exampleNews = [
  ...
  },
  {
    ...
    title: "They forecast record growth of Elon Musk’s favorite cryptocurrency",
    description:
...
const NEWS_API_KEY = "0HKvHNXuTbiREiO9dpQSQnr8geN0cJYl5NuocDu3";
const NEWS_URL = `https://api.thenewsapi.com/v1/news/all?api_token=${NEWS_API_KEY}`;

function News(): React.ReactNode {
  const [news, setNews] = useState<NewsItem[]>(exampleNews);
